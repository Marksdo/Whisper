...
| ![Whisper Mate icon](../images/appicon-128x128.png) | Whisper Mate omvandlar ljud och video till finslipade undertexter, översättningar och exporter – allt bearbetas lokalt på din Mac så att varje projekt förblir privat. Ladda ned från macOS App Store: [Whisper Mate](https://apps.apple.com/us/app/id6450404233) |
| --- | --- |
